                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a class="btn btn-primary btn-round ms-auto" href="{{ route('kepala-bps.izin.create') }}">
                            ...
                            @forelse ($izins as $izin)
                                <tr>
                                    ...
                                    <div class="form-button-action d-flex gap-2">
                                        ...
                                        {{-- SHOW / DETAIL --}}
                                        <a href="{{ route('kepala-bps.izin.show', $izin->id_izin) }}"
                                        ...
                                        {{-- EDIT --}}
                                        <a href="{{ route('kepala-bps.izin.edit', $izin->id_izin) }}"
                                        ...
                                        {{-- DELETE --}}
                                        <form action="{{ route('kepala-bps.izin.destroy', $izin->id_izin) }}"
                                            method="POST"
