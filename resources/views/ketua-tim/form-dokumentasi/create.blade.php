            ...
            <div class="page-inner">
                ...
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('ketua-tim.dokumentasi.index') }}">Dokumentasi</a>
                        </li>
                    </ul>
                </div>
                <!-- END PAGE HEADER -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- FORM -->
                        <form action="{{ route('ketua-tim.dokumentasi.store') }}" method="POST" id="dokumentasiForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card">
                                ...
                                <div class="card-action d-flex justify-content-end">
                                    ...
                                    <a href="{{ route('ketua-tim.dokumentasi.index') }}" class="btn btn-danger ms-2">Batal</a>
                                </div>
