    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item"><a href="{{ route('admin.akun.index') }}">Akun</a></li>
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="#">Isi Akun</a></li>
            </ul>
        </div>

        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('admin.akun.store') }}" method="POST" id="akunForm">
                    @csrf
                    <div class="card">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="role" name="role"
                                            ...
                                            <option value="kasubbag_umum" {{ old('role')=='kasubbag_umum' ? 'selected' : '' }}>Kepala Subbagian Umum</option>
