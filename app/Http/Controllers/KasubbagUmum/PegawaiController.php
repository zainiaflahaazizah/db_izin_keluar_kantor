...
class PegawaiController extends Controller
{
    ...
    {
        return view('kasubbag-umum.pegawai.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        //redirect to index
        return redirect()->route('kasubbag-umum.pegawai.index')->with(['success' => 'Data Berhasil Disimpan!']);
    }
    ...
    public function show(string $id_pegawai): View
    {
        ...
        return view('kasubbag-umum.pegawai.show', compact('pegawai'));
    }
    ...
    public function edit(string $id_pegawai): View
    {
        ...
        //render view with pegawai
        return view('kasubbag-umum.pegawai.edit', compact('pegawai'));
    }
    ...
    public function update(Request $request, $id_pegawai): RedirectResponse
    {
        ...
        //redirect to index
        return redirect()->route('kasubbag-umum.pegawai.index')->with(['success' => 'Data Berhasil Diubah!']);
    }
    ...
    public function destroy($id_pegawai): RedirectResponse
    {
        ...
        //redirect to index
        return redirect()->route('kasubbag-umum.pegawai.index')->with(['success' => 'Data Berhasil Dihapus!']);
    }
}
