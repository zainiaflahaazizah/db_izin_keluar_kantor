...
class DokumentasiController extends Controller
{
    public function index()
    {
        ...
        return view('kasubbag-umum.form-dokumentasi.index', compact('dokumentasis'));
    }
    ...
    {
        return view('kasubbag-umum.form-dokumentasi.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kasubbag-umum.dokumentasi.index')
    ...
    public function show(string $id_dokumentasi): View
    {
        ...
        return view('kasubbag-umum.form-dokumentasi.show', compact('dokumentasi'));
    }
