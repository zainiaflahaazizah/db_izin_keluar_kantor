...
class IzinController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('kepala-bps.form-izin.create', compact('pegawais'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('kepala-bps.izin.index')
    ...
    public function show(string $id_izin): View
    {
        ...
        return view('kepala-bps.form-izin.show', compact('izin'));
    }
    ...
    public function edit(string $id_izin): View
    {
        ...
        return view('kepala-bps.form-izin.edit', compact('izin', 'pegawais'));
    }
