...
class PegawaiController extends Controller
{
    public function index() : View
    {
        ...
        return view('kepala-bps.pegawai.index', compact('pegawais'));
    }

    public function create(): View
    {
        return view('kepala-bps.pegawai.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        //redirect to index
        return redirect()->route('kepala-bps.pegawai.index')->with(['success' => 'Data Berhasil Disimpan!']);
    }
    ...
    public function show(string $id_pegawai): View
    {
        ...
        return view('kepala-bps.pegawai.show', compact('pegawai'));
    }
    ...
    public function edit(string $id_pegawai): View
    {
        ...
        //render view with pegawai
        return view('kepala-bps.pegawai.edit', compact('pegawai'));
    }
    ...
    public function update(Request $request, $id_pegawai): RedirectResponse
    {
        ...
        //redirect to index
        return redirect()->route('kepala-bps.pegawai.index')->with(['success' => 'Data Berhasil Diubah!']);
    }
    ...
    public function destroy($id_pegawai): RedirectResponse
    {
        ...
        //redirect to index
        return redirect()->route('kepala-bps.pegawai.index')->with(['success' => 'Data Berhasil Dihapus!']);
    }
}
